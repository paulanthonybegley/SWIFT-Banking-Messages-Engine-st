 ...
 * <b>SubFields</b>
 * <pre>
 * 1: 16x    - Transaction Reference
 * </pre>
 */
public class TransactionReference implements SwiftField {
    ...
    public TransactionReference(String content) {
    ...
    public static TransactionReference of(GeneralField field) throws FieldNotationParseException {
